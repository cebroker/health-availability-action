...
const core = __nccwpck_require__(953);
...
var settle = __nccwpck_require__(246);
var buildFullPath = __nccwpck_require__(252);
var buildURL = __nccwpck_require__(653);
var http = __nccwpck_require__(685);
var https = __nccwpck_require__(687);
var httpFollow = (__nccwpck_require__(198).http);
var httpsFollow = (__nccwpck_require__(198).https);
var url = __nccwpck_require__(310);
var zlib = __nccwpck_require__(796);
var VERSION = (__nccwpck_require__(717).version);
var createError = __nccwpck_require__(413);
var enhanceError = __nccwpck_require__(201);
var defaults = __nccwpck_require__(395);
var Cancel = __nccwpck_require__(858);
...
var utils = __nccwpck_require__(958);
var settle = __nccwpck_require__(246);
var cookies = __nccwpck_require__(684);
var buildURL = __nccwpck_require__(653);
var buildFullPath = __nccwpck_require__(252);
var parseHeaders = __nccwpck_require__(483);
var isURLSameOrigin = __nccwpck_require__(651);
var createError = __nccwpck_require__(413);
var defaults = __nccwpck_require__(395);
var Cancel = __nccwpck_require__(858);
...
var utils = __nccwpck_require__(958);
var bind = __nccwpck_require__(96);
var Axios = __nccwpck_require__(351);
var mergeConfig = __nccwpck_require__(350);
var defaults = __nccwpck_require__(395);
...
axios.Cancel = __nccwpck_require__(858);
axios.CancelToken = __nccwpck_require__(226);
axios.isCancel = __nccwpck_require__(937);
axios.VERSION = (__nccwpck_require__(717).version);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __nccwpck_require__(965);

// Expose isAxiosError
axios.isAxiosError = __nccwpck_require__(840);
...
var utils = __nccwpck_require__(958);
var buildURL = __nccwpck_require__(653);
var InterceptorManager = __nccwpck_require__(924);
var dispatchRequest = __nccwpck_require__(838);
var mergeConfig = __nccwpck_require__(350);
var validator = __nccwpck_require__(435);
...
var isAbsoluteURL = __nccwpck_require__(554);
var combineURLs = __nccwpck_require__(936);
...
var utils = __nccwpck_require__(958);
var transformData = __nccwpck_require__(278);
var isCancel = __nccwpck_require__(937);
var defaults = __nccwpck_require__(395);
var Cancel = __nccwpck_require__(858);
...
var utils = __nccwpck_require__(958);
var normalizeHeaderName = __nccwpck_require__(147);
var enhanceError = __nccwpck_require__(201);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __nccwpck_require__(502);
  } else if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    // For node use HTTP adapter
    adapter = __nccwpck_require__(856);
  }
  return adapter;
}
...
module.exports = __nccwpck_require__(815)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __nccwpck_require__(65);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __nccwpck_require__(182);
} else {
...
try {
	...
	const supportsColor = __nccwpck_require__(360);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(803)("follow-redirects");
    }
    catch (error) { /* */ }
...
var debug = __nccwpck_require__(861);
